            ...
            child: SafeArea(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    CustomText(text: "Forgot password",fontSize:7.sp ,fontWeight: FontWeight.bold,color: Colors.grey.shade800,),
                    SizedBox(height:3.h),
                    CustomText(text: "Enter your email ",fontWeight: FontWeight.bold,fontSize:6.sp,color: Colors.grey.shade800),
                    SizedBox(height:0.5.h),
                    CustomText(text: "We will sent you a link to reset password",fontSize:4.8.sp,color: Color(0xff989898),fontWeight: FontWeight.bold),
                    SizedBox(height:3.h),
                    CustomText(text: "Email",color: Colors.grey.shade600,fontSize:6.sp,fontWeight: FontWeight.bold,),
                    SizedBox(height:1.h),
                    CustomTextField(
