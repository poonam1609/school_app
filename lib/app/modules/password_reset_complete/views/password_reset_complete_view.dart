...
class PasswordResetCompleteView extends GetView<PasswordResetCompleteController> {
  PasswordResetCompleteController passwordResetCompleteController = Get.put(PasswordResetCompleteController());
      ...
      body: Container(
          ...
          child: SafeArea(child: Center(child: Padding(
            ...
            child: Column(
              ...
              children: [
                SvgPicture.asset('assets/icons/icon_verificationcomlete.svg'),
                SizedBox(height: 1.h,),
                CustomText(text: "Successful",fontSize:7.sp ,fontWeight: FontWeight.bold,color: Colors.grey.shade800,),
                SizedBox(height: 4.h,),
                CustomText(text: "Congratulations! Your password has \nbeen changed. Click return to login",fontSize:6.sp ,fontWeight: FontWeight.bold,color: Colors.grey.shade500,),
                SizedBox(height: 7.h,),
                PrimaryButton(text: 'Return to Login', onPressed:(){Get.toNamed(Routes.LOGIN);},color: Theme.of(context).primaryColor,)
              ],
            ),
          ))))
  );
